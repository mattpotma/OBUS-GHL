...
uv run ghlobus/inference/tflite_inference.py --task=GA --tflite_dir=./tflite_models --dicom=/home/matt/src/OBUS-GHL/dicoms/test.dcm --outdir=./test_tflite --tflite_model_name=unified_model_50.tflite
uv run ghlobus/inference/tflite_inference.py --task=GA --tflite_dir=./tflite_models --dicom=/home/matt/src/OBUS-GHL/dicoms/test.dcm --outdir=./test_tflite --tflite_model_name=unified_model_opt_50.tflite
